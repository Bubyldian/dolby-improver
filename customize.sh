...
REPLACE="/system/vendor/etc/audio/sku_taro
/system/vendor/etc/audio/sku_cape
/system/vendor/etc/audio/sku_diwali
/system/vendor/etc/audio/sku_parrot
/system/vendor/etc/audio/sku_taro_qssi
/system/vendor/etc/audio/sku_cape_qssi
/system/vendor/etc/audio/sku_diwali_qssi
/system/vendor/etc/audio/sku_parrot_qssi"
